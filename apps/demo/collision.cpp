/* $Id: collision.cpp 60 2008-05-23 07:00:03Z greg $ */
                           ...
                           void *sr, void *)
{
  ...
  printf("Ring acc: %f\n",mag_vector3(r2.outer_masses[0]->acc));
  printf("Ring vel: %f\n",mag_vector3(r2.outer_masses[0]->vel));
  iterate_universe(u);
...
int main (int argc, char **argv)
{
  ...
  */
  ...
  //extended_object *eo3 = new_extended_object(u,"billiards",102);
  ...
  */
  ...
  vector3 xv,b1loc,b2loc,b1acc,b2acc;
 ...
 //  mass_element *b1 =  new_mass_element(eo, b1loc,zerovec,
// 				       b1acc, 0.5,300, "Stationary Ball", 0);


//   mass_element *b2 =  new_mass_element(eo, b2loc,zerovec,
